    ...
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl text-center">
        ...
        <p class="mt-2 text-lg leading-8 text-gray-600">
            Ready to take the next step towards turning your software into market-ready products? 
            We're excited to hear from you! Contact us today to kickstart your software transformation journey.
        </p>
      </div>
        ...
        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div class="sm:col-span-2">
            ...
            <div class="relative mt-2.5">
              ...
              <input type="tel" name="phone-number" id="phone-number" autocomplete="tel" required class="block w-full rounded-md border-0 px-3.5 py-2 pl-20 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          <div class="sm:col-span-2">
